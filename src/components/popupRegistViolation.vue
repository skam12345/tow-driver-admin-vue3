      ...
      <div class="popup_contents">
        ...
        <div class="popup_contents_bottom">
          <div class="btn_cont">
            ...
            <!-- <div class="bottom_btns_add" @click="uploadImg()">테스트</div> -->
          </div>
        </div>
      </div>
    </div>
  ...
  setup() {
    ...
    const uploadImg = async () => {
      ...
      for (let i = 0; i < imgFiles.value.length; i++) {
        ...
        switch (i) {
          case 0:
            vdaImg01Path.value = `${imagePathForDB}/${imgFiles.value[i].name}`;
            break;
          case 1:
            vdaImg02Path.value = `${imagePathForDB}/${imgFiles.value[i].name}`;
            break;
          case 2:
            vdaImg03Path.value = `${imagePathForDB}/${imgFiles.value[i].name}`;
            break;
          case 3:
            vdaImg04Path.value = `${imagePathForDB}/${imgFiles.value[i].name}`;
            break;
        }
      }
    };
        ...
        await axios
          ...
          .then((res) => {
            ...
            if (res.data.result === "SUCCESS") {
              ...
              vdaAllotDate.value = "";
              aciRegionCode.value = "";
              vdaImg01Path.value = null;
              vdaImg02Path.value = null;
              vdaImg03Path.value = null;
              vdaImg04Path.value = null;
              si.value.selectedData = "서울특별시";
              gu.value.selectedData = "";
              extraAddress.value = "";
              address.value = "";
