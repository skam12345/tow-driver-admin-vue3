      ...
      <div class="popup_contents">
        ...
        <div class="popup_contents_body">
          ...
          <div class="popup_contents_body_input_cont">
            ...
            <div class="popup_contents_body_input_pw">
              <label for="phoneNo" style="position: inherit; margin-bottom: 2%"
                >연락처(- 없이 입력)</label
              >
              <input
                type="text"
          ...
          <div class="popup_contents_body_input_cont">
            <div class="popup_contents_body_input_pw">
              ...
              <input
                type="text"
                id="companyCode"
                v-model="aiaRegionCode"
                placeholder="담당 행정동 코드"
                maxlength="4"
                disabled
              />
            </div>
